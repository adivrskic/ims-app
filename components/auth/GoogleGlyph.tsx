 ...
 *
 * Decorative: the adjacent button text supplies the accessible name, so the
 * SVG is aria-hidden to avoid a redundant "Google" announcement.
 */
interface Props {
  size?: number;
  className?: string;
...
export function GoogleGlyph({ size = 14, className }: Props) {
  return (
    <svg
      viewBox="0 0 48 48"
      width={size}
