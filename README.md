...
- **Tests** — Vitest unit suite over critical pure logic (`npm test`, 284 tests); no E2E suite yet. Manual coverage is [`docs/QA-TEST-PLAN.md`](docs/QA-TEST-PLAN.md), which is route-complete.
